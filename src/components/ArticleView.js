...
class ArticleView extends Component {
  ...
  render() {
    const { text, claps, title, feature_img, author, _id } = this.props._article
    const { user, clap } = this.props;
          ...
          <div className="row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
            <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
              <div className="pull-right">
                {
                   user 
                  ? <FollowButton user={`${user.following}`} to_follow={`${author_id}`} /> 
                  : ''
                }
              </div>
                ...
                <div className="post-stats flex-container">
                  ...
                  <div className="bookmark-button">
                    <div className="bookmark-button-wrapper">
                      <form className="button_to" method="get" action="">
                        <button className="bookmark-button" data-behavior="trigger-overlay" type="submit">
                          <span className="icon-bookmark-o"></span><span className="hide-text">
                            Bookmark
                          </span>
                        </button>
                      </form>
